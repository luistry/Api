...
const productos = [
  ...
  },
  {
    ...
    descripcion: "Los Nike Panda son el nuevo modelo de Zapatos Lanzado por Nike para su desarrollo de los cuales son una manera extravagante de vestir",
    disponibilidad: "Disponible",
    cantidadEnStock: 3,
  },
  {
    ...
    descripcion: "Converse Nos Ofrece una variedad de Calzado para vestir bien, Su modelo Clasico No son la Excepcion",
    disponibilidad: "Disponible",
    cantidadEnStock: 2,
  },
  {
    ...
    precio: 100,
    descripcion: "Los Nike Air Jordan Retro Shadow un Modelo Expectacular que demuestra el estilo",
    cantidadEnStock: 1,
  },
  {
    id: 5,
    ...
    precio: 70,
    descripcion: "Los Adidas Originals Combinan con el Estilo y son una gran opcion",
    cantidadEnStock: 2,
  },
  {
    id: 6,
    ...
    precio: 40,
    descripcion: "Los Puma Clasicos es una opcion un tanto innovadora como sutil a la hora de lucir",
    cantidadEnStock: 1,
  },
];
...
// Iniciar el servidor y mostrar la ruta en la consola
const PORT = 3000;
app.listen(PORT, () => {
  console.log(`Servidor iniciado en http://localhost:${PORT}/productos`);
});
